...
urlpatterns = [
    path('atender_solicitud/<int:solicitud_id>/',
         atender_solicitud, name='atender_solicitud'),
    path('marcar-en-proceso/<int:solicitud_id>/',
         marcar_solicitud_en_proceso, name='marcar_solicitud_en_proceso'),
